...
> _Merci Michel pour ce stage, c’est la toute première fois que j’enseignais à des élèves et c’est une expérience que j’ai vraiment apprécié. Ça m’a vraiment permit de prendre confiance en moi. Merci pour les 50 euros (j’économise pour m’acheter un iPad pour mes études ). Merci à toi et Morgann pour tout et bonne fin de vacances_ - Nabila, élève-tutrice à l'association Maths et Maryam.
...
{{< figure src="assos/stage-college.jpg" caption="Travaux pratiques (couper un gâteau en 2, puis en 4, 8, 16... et 6) pour revoir les notions de fraction, d'angle, de bissectrice, de médiatrice, etc.">}}

Nous avons réutilisé des exercices de mathématiques de l'association Sesamaths:
* Exercices sur la <b>proportionnalité</b>: En [6e](https://manuel.sesamath.net/coll_docs/cah/valide/ds_chapitre_2013_6D1.pdf) et en [5e](https://manuel.sesamath.net/coll_docs/cmep/valide/kidimath_DS_5N5.pdf).
* Exercices sur les <b>angles</b>: En [6e](https://manuel.sesamath.net/coll_docs/cmep/valide/kidimath_DS_6M1.pdf) et en [5e](https://manuel.sesamath.net/coll_docs/cmep/valide/kidimath_DS_5N5.pdf).
...
* Exercices sur les <b>statistiques</b>: En [6e](https://manuel.sesamath.net/coll_docs/cah/valide/ds_chapitre_2013_6D2.pdf) et en [5e](https://manuel.sesamath.net/coll_docs/cmep/valide/kidimath_DS_5N6.pdf).
* Exercices sur les aires et périmètres: En [6e](https://manuel.sesamath.net/coll_docs/cah/valide/ds_chapitre_2013_6M2.pdf), en [5e](https://manuel.sesamath.net/coll_docs/cmep/valide/kidimath_DS_5G4.pdf) et en [4e](https://mathadoc.sesamath.net/Documents/college/4eme/4equat/d10equat.pdf) (calcul littéral).
...
Nous avons aussi réutilisé des dictées du site Réussir à l'école:
...
|---|---|
| Proportionnalité et calcul mental | Vente de baguettes (boulangerie) |
| Symétrie axial | [Dessin du chat](https://i.pinimg.com/736x/7b/8f/db/7b8fdb2d967348994dbca52aad6abbb2.jpg) |
| Les angles et fractions | Couper un gâteau en 2, 4, 8, 6 |
| Les points, segments et droites | Patron (cube) et Origami|
...
Chaque élève a bénéficié d'un bilan personnalisé pour aborder la rentrée sereinement.
